...
export default function ManagePage() {
  return (
    <section className={`${card} relative overflow-hidden p-5`}>
      <div className="pointer-events-none absolute inset-0 bg-[radial-gradient(circle_at_top_right,rgba(56,189,248,0.12),transparent_26%),radial-gradient(circle_at_bottom_left,rgba(14,165,233,0.08),transparent_22%)]" />
      ...
      <div className="relative mt-5 grid gap-3 sm:grid-cols-3">
        <div className="border border-slate-700 bg-slate-950/60 p-4">
          ...
          <p className="mt-2 flex items-center gap-2 text-sm text-slate-300">
            <GridIcon className="h-4 w-4 text-sky-300" />
            Orders + settings
          </p>
        </div>
        <div className="border border-slate-700 bg-slate-950/60 p-4">
          ...
          <p className="mt-2 flex items-center gap-2 text-sm text-slate-300">
            <SearchIcon className="h-4 w-4 text-sky-300" />
            /orders
          </p>
        </div>
        <div className="border border-slate-700 bg-slate-950/60 p-4">
